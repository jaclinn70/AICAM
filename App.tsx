...
>
    ...
    {mode === 'CAMERA' && (
  <div
    className="fixed left-0 top-0 w-full bg-black overflow-hidden flex justify-center"
    style={{ height: tgHeight ? `${tgHeight}px` : '100vh' }}
  >
    {/* 9:16 physical container */}
    <div
    ...
    >
      ...
      <video
        ...
        playsInline
        muted
        className={`absolute left-1/2 top-1/2 min-w-full min-h-full 
